...
export declare namespace BrowsingContext {
    type SetBypassCspResult = EmptyResult;
}
export declare namespace BrowsingContext {
    type SetViewport = {
...
export type EmulationCommand = Emulation.SetForcedColorsModeThemeOverride | Emulation.SetGeolocationOverride | Emulation.SetLocaleOverride | Emulation.SetNetworkConditions | Emulation.SetScreenOrientationOverride | Emulation.SetScreenSettingsOverride | Emulation.SetScriptingEnabled | Emulation.SetScrollbarTypeOverride | Emulation.SetTimezoneOverride | Emulation.SetTouchOverride | Emulation.SetUserAgentOverride;
